            ...
            <form onSubmit={handleSubmit}>
              <div className='row py-5'>
                ...
                <div className="col-md-6 mb-4">
                  ...
                  <h5>Item Sequence</h5>
                  <input type="number" className='form-control' placeholder='Item Sequence' name="iSeq" onChange={handleBom} required />

                </div>
                <div className="col-md-6 mb-4">

                  <h5>Operation Sequence</h5>
                  <input type="number" className='form-control' placeholder='Operation Sequence' name="opSeq" onChange={handleBom} required />
                ...
                <div className="col-md-6 mb-4">
                  ...
                  <h5>Item Quantity</h5>
                  <input type="number" className='form-control' placeholder='Item Quantity' name="iQuan" onChange={handleBom} required />
                ...
                <div className="col-md-6 mb-4">
                  ...
                  <h5>Garment Cost</h5>
                  <input type="number" className='form-control' placeholder='Garment Cost' name="gCost" onChange={handleBom} required />

                </div>
                <div className="col-md-6 mb-4">

                  <h5>Rate</h5>
                  <input type="number" className='form-control' placeholder='Rate' name="rate" onChange={handleBom} required />
                  ...
                  user && user.userRole === "planner" ?
                    ...
                    <div className='row'>
                      ...
                      <div className="col-md-6 mb-4">
                        ...
                        <input type="number" className='form-control' placeholder='Finish Item Code' name="fItemCode" onChange={handleBomOrder} required />
                      ...
                      <div className="col-md-6 mb-4">
                        ...
                        <input type="number" className='form-control' placeholder='Standard Minutes' name="stMin" onChange={handleBomOrder} required />
                      ...
                      <div className="col-md-6 mb-4">
                        ...
                        <h5>BOM Date</h5>
                        <input type="text" className='form-control' placeholder='Bom Date' name="bomDate" onChange={handleBomOrder} required />

                      </div>
                      <div className="col-md-6 mb-4">

                        <h5>Exchange Rate</h5>
                        <input type="number" className='form-control' placeholder='Exchange Rate' name="exRate" onChange={handleBomOrder} required />

                      </div>
                      <div className="col-md-6 mb-4">

                        <h5>Date Exchange Rate</h5>
                        <input type="text" className='form-control' placeholder='Date Exchange Rate' name="dExrate" onChange={handleBomOrder} required />
